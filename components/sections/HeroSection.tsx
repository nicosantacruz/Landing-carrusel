      ...
      <div className="container relative z-10 hidden md:block pt-24">
        <div className="space-y-6 max-w-xl mx-0">
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            <Button
              variant="outline"
              className="rounded-full border-2 px-7 py-5 text-base font-medium bg-white text-blue-900 border-blue-200 hover:bg-blue-50 h-auto transition-all duration-300 hover:scale-105"
      ...
      <div className="container relative z-10 block md:hidden flex flex-col justify-center" style={{ minHeight: '25vh', marginTop: '-20vh', marginBottom: '0' }}>
        <div className="space-y-4 max-w-full mx-auto" style={{ marginTop: 0, marginBottom: 0 }}>
          ...
          <div className="flex justify-center mt-8">
            <Button
              variant="outline"
              className="rounded-full border-2 px-5 py-1.5 text-sm font-semibold bg-blue-700 text-white border-blue-700 shadow-sm w-auto min-w-[140px] max-w-[200px] h-auto transition-all duration-300 hover:scale-105"
